...
//Я сделал обработчик состояния, теперь осталось сделать:
// Чтобы после выбора подарка мы вешали состояние wait_description
// и потом только к оплате переходить
// сделать чтобы во время wait_description можно было написать /skip чтобы
// выйти с него и отправить без description
